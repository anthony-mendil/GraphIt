...
/**
 * Defines a functor that transform a vertex into its shape. The input vertex left unchanged. Its extracting the shape
 * of a vertex.
 *
...
public class VertexShapeTransformer<V> extends AbstractVertexShapeTransformer<V> implements Transformer<V, Shape> {
    /**
     * creates a vertex shape transformer with with the specified vertex size
     *
