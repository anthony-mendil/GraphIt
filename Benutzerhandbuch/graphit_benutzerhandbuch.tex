...
\begin{tabular} {|p{8cm}|p{8cm}|}
	...
	Datei öffnen & Ctrl + O \\ \hline
	Speichern unter	&	Ctrl + S \\ \hline
	Importieren als Vorlage & Ctrl + I \\ \hline
	Importieren als GXL & Ctrl + Shift + I \\ \hline
	Exportieren als Vorlage & Ctrl + E \\ \hline
	Exportieren als GXL & Ctrl + Shift + E \\ \hline
	Exportieren als PDF & Ctrl + Shift + P \\ \hline
	Exportieren als Verlaufsprotokoll & Ctrl + L \\ \hline 
	GraphIt schließen & Ctrl + Q \\ \hline 
	Dokumentation & F1 \\ \hline 
	Über uns & F2 \\ \hline 
	Graphelemente vergrößern & + \\ \hline
	Graphelemente verkleinern & - \\ \hline 
	Rückgängig 	& Ctrl + Z \\ \hline 
	Wiederherstellen & Ctrl + Y \\ \hline 
	Graphelemente löschen & Ctrl + D / Entf \\ \hline 
	Alle Elemente auswählen & Ctrl + A \\ \hline 
	Filtern/ Suchen	& Ctrl + F \\ \hline 
	Ersteller- Modus & 2 \\ \hline
	Bearbeiter- Modus & 1 \\ \hline
	Analyse- Modus & 3 \\ \hline
	Auswahl leeren & Esc	\\ \hline
\end{tabular}
