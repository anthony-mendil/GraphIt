...
\begin{tabular} {|p{4.5cm}|p{5.5cm}|p{5.5cm}|}
	\hline & Minimal & Empfohlen \\\hline
	Prozessor &  & \\\hline
	Arbeitsspeicher & MB & MB\\\hline
	Festplattenspeicher & 30 MB verfügbarer Speicherplatz & 50 MB verfügbarer Speicherplatz \\\hline
	Grafikspeicher &  MB & MB \\\hline
\end{tabular}
\subsubsection{Betriebssystem}
Um die Funktionalität der Anwendung zu gewährleisten, muss eins der folgenden Betriebssysteme installiert sein:
\begin{itemize}
...
Zum Starten des Programms muss die Ausführbare Datei \texttt{GraphIt.jar} ausgeführt werden. Dadurch wird die Anwendung initialisiert und ggf. eine Datenbank im \texttt{home}-Verzeichnis des Nutzers angelegt. Zweiteres geschieht nur beim erstmaligen Start der Anwendung. \\
