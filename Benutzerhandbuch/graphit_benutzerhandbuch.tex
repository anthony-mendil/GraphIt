...
\subsubsection{Bildschirmauflösung}
\subsubsection{}
...
\begin{itemize}
	...
	\item MacOS TODO (E0 Mac testen und version angeben)\\
	\item Linux \\
\end{itemize}
\subsubsection{Java 8}
Zur Benutzung von \textbf{GraphIt} muss eine gültige Version von Java 8 mit JavaFX installiert sein. 

\subsection{Installationsanweisungen}
\begin{itemize}
	\item Die Anwendung benötigt keinen vom Nutzer geführten Installationsvorgang, bevor sie benutzt werden kann.
\end{itemize}
\subsection{Starten des Programms}
Zum Starten des Programms muss die Ausführbare Datei \texttt{GraphIt.jar} ausgeführt werden. Dadurch wird die Anwendung initialisiert und ggf. eine Datenbank im \texttt{home}-Verzeichnis des Nutzers angelegt. Zweiteres geschieht nur beim erstmaligen Start der Anwendung. Nach dem Startvorgang ist das Programm direkt einsatzbereit.
