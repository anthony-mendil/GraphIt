...
\subsubsection{Filtern}
	...
	\begin{figure}[ht!]
		\centering
		\subfigure[Verlauf]{
			\includegraphics[width=0.8\columnwidth, keepaspectratio]{logs.png} 
		}
...
\end{enumerate}
 ...
 \begin{figure}[ht!]
 	...
 	\subfigure[Exportieren/ Speichern]{
 		\includegraphics[width=0.5\columnwidth, keepaspectratio]{save.png} 
 	}
 	\subfigure[Öffnen/ Importieren]{
 		\includegraphics[width=0.5\columnwidth, keepaspectratio]{open.png} 
 	}	
 \end{figure}
