...
Für die Tests für den Verlauf und die Übersicht erstellen wir vorerst mit \texttt{Datei} und \texttt{Neue Datei} eine neue Datei. Anschließend führen wir folgende Aktionen aus: \\
\begin{itemize}  
\item Sphäre hinzufügen
\item Symptom in die Sphäre hinzufügen (Symptom 1) 
\item Symptom in die Sphäre hinzufügen (Symptom 2)
\item Relation zwischen 
\item 
\item 
\item 
\item 
