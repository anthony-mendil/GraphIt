...
Die Realisierung unserer Anwendung erfolgt durch mehrere Threads. Die GUI als auch die SwingNodes des Frameworks JUNG werden auf einem eigenen Thread laufen (siehe folgende Abbildung: Ausführungssicht). Somit wird für eine durchgehend ansprechbare und dadurch angenehmer bedienbare Benutzeroberfläche, gemäß \hyperlink{g}{Hoher Usability}, gesorgt.\\
