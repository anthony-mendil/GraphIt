...
\newpage
Alle Attribute sind private, es existieren aber Getter und Setter (außer bei Ids  von Vertex, Edge und Sphere, dort nur Getter), weshalb sie als public markiert werden. \\
