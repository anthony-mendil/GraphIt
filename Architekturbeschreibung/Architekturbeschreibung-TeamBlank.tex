...
Mit den Methoden der \texttt{PDFio-Klasse}, die ebenfalls im \texttt{io-package} zu finden ist, werden später unter Einsatz der Frameworks beziehungsweise APIs der PDF-Druck (gemäß Strategie \hyperlink{ggg}{S26: Java API}, die PDF-Erstellung (gemäß Strategie \hyperlink{hhh}{S29 - java.awt.Graphics2D} und der PDF-Export (gemäß Strategeie \hyperlink{iii}{S30 - Freeheb Vectorgraphics} realisiert. \\ \\
