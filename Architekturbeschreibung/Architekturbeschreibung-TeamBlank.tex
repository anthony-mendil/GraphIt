...
Des weiteren lassen sich die Rollennamen direkt aus den Klassennamen herleiten, weshalb wir sie im Diagramm nicht explizit nennen. Bezüglich der Assoziation zwischen \texttt{Vertex} und \texttt{ScopePoint} wurde beschlossen, dass \texttt{Vertex} statt einem Attribut, welches die verschiedenen \texttt{ScopePoints} für die jeweiligen Arten der Pfeiltypen zusammenfasst, drei Attribute verwendet werden, die jeweils ausschließlich bezüglich des Pfeiltyps gleichartige \texttt{ScopePoints} beinhalten. Diese Unterteilung sorgt für eine klare logische Trennung und ermöglicht es ohne Filterung direkt auf die \texttt{ScopePoints} zuzugreifen, die einem Pfeiltyp entsprechen.\\
