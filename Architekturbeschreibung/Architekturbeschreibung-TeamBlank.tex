...
In der folgenden Abbildung ist unsere Ausführungssicht zu erkennen. Da es sich nach den Anforderung um eine eine lokale Anwendung handelt, gibt es pro Nutzer genau eine Instanz der Anwendung. Darüber hinaus ist die zeitgleiche Ausführung mehrerer Instanzen unserer Anwendung nicht vorgesehen und könnte zu Fehlern, insbesondere bei der Kommunikation mit der eingebetteten H2-Datenbank, kommen. \\

Da die Anwendung auf einem Thread läuft, werden alle Module auf dem Hauptprozess des Clients ausgeführt. \\
Für den Start der Anwendung ist dabei das Modul \texttt{gui} zuständig. \\
\\ \\
