...
\begin{tabular} {|p{8cm}|p{8cm}|}
	...
	\hline
	\multicolumn{2}{|l|} {\textbf{Auswirkungen}} \\
	\multicolumn{2}{|l|} {{16cm}{Das Protokoll muss so in der verwendeten relationalen Datenbank gespeichert werden, dass es möglich ist, durch Anfragen an die Datenbank an die nötigen Informationen zu gelangen, um das Protokoll in den geforderten Formen zu erstellen.} }\\ \hline
\end{tabular}
\\ \\ \\ \\ %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Datensicherung/Persistenz des Graphen}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Persistierungsintervall des Graphen}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Datensicherung/Persistenz der Nutzerinteraktionen}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Auswahl der grundlegenden Softwarearchitektur}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Unerfahrene Entwickler}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S11 - (System) Biblotheken}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Ausfallende Entwickler}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S16 - Dokumentierte Bibliotheken}}\\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Visualisierung, Editierung und Interaktion mit dem Graphen}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Auswertung von Grapheigenschaften}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{\parbox{16cm}{
			...
			\textbf{\cb{24 - eigene Implementierung}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{PDF Druck}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ PDF Erstellung}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{\parbox{16cm}{
			...
			\textbf{\cb{S29 - java.awt.Graphics2D}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Bibliothek für den PDF Export von java.awt.Graphics2D}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S30 - Freeheb Vectorgraphics}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Protokoll der Nutzerinteraktionen exportieren/ importieren}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{\parbox{16cm}{
			...
			\textbf{S33 - JavaScript Object Notation (.json)} \\
...
\begin{onehalfspace}
	...
	\cb{Sx} würde vom Prinzip auch funktionieren. Da das Datenmodell bereits .json einbindet und so wenig wie möglich verschiedene Dateiformate in unserem System eingebunden sein sollen, um Fehler zu vermeiden, entschieden wir uns gegen \cb{S32}.
\end{onehalfspace}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\newpage
\hspace{-0.65cm}
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Benutzeroberfläche}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S34 - GUI Framework JavaFx}} \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Einbettung JUNG als Swing GUI- Framework in eine JavaFx Application}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Benutzeroberflächenerstellung mit JavaFx}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Begrenzter Funktionsumfang durch Bearbeitszeit}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S40 - erweiterte Anforderungen}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Protokolldaten und Graphdaten zusammen sichern}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Verwendung einer Embedded Database}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Einhaltung der Abgabetermine}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S47 - Verwendung von (System)- Bibliotheken}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Kommunikation Zielplattform (Java) mit embedded DB}}} \\  \hline\hline 
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Übersichtlichkeit in der Sphäre und im Graphen}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S53 - Layouts in Layouts}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ GXL Erstellung}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S56 - Sourceforge Framework}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{Umsetzung der Funktionsmodi}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S59 - Modi als eigener Teil unserer Applikation}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Vorlage}}} \\  \hline\hline 
	...
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S61 - Regeln in der GXL-Datei}}: \\
...
\begin{tabular} {|p{8cm} p{8cm}|}
	\hline
	\rowcolor{prob}\multicolumn{2}{|l|}{\parbox{16cm}{\textbf{ Überschrift}}} \\  \hline\hline 
	\multicolumn{2}{|l|}{\parbox{16cm}{Beschreibung}}\rule{0pt}{1ex}\\ [1ex] \hline
	\multicolumn{2}{|l|}{\textbf{Einflussfaktoren}}\\
	Faktor 1 & Faktor 2  \\ \hline
	\multicolumn{2}{|l|}{Lösungen} \\
	\multicolumn{2}{|l|}{\parbox{16cm}{
			\textbf{\cb{S1 - }}: \\
			Beschreibung \\
...
\begin{tabular} {|p{14cm}|}
	\hline
	00: Name der Problemkarte \\ \hline
	Hier steht ein Text dessen Aufgabe es ist die Problemkarte zu beschreiben - also zu sagen, worum es sich bei dieser Karte handelt.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 8 oder höher als Implementierungssprache\\
	\hyperlink{P01.2}{P01.2} Verwendung von Maven als Build-System\\
	\hyperlink{P01.3}{P01.3} Benutzung einer leichtgewichtigen Datenbank\\
	\hyperlink{P02.1}{P02.1} Betriebssystemunterstützung / Zielplattformen des Systems\\
	\hyperlink{P02.2}{P02.2} Datenschutz\\
	\hyperlink{P02.3}{P02.3} Datenbank-Backup\\
	\hyperlink{P03.1}{P03.1} Funktionsmodi\\
	\hyperlink{P03.2}{P03.2} Filter\\
	\hyperlink{P03.3}{P03.3} Zoom \\
	\hyperlink{P03.4}{P03.4} Zoom.Kontext\\
	\hyperlink{P03.5}{P03.5} Sprache\\
	\hyperlink{P03.6}{P03.6} GXL-Export und -Import\\
	\hyperlink{P03.7}{P03.7} Tracking von Nutzerinteraktionen\\
	\hyperlink{P03.8}{P03.8} Veränderbarkeit visueller Grapheigenschaften \\
	\hyperlink{O 01}{O 01} Teamgröße\\
	\hyperlink{O 02}{O 02} Abgabedatum\\
	\hyperlink{O 03}{O 03} Teamfähigkeiten\\
	\hyperlink{O 04}{O 04} Softwarelizenzbudget \\
	\hyperlink{T 01}: Dokumentation\\
	\hyperlink{T 02}: Softwaretests\\
	\hyperlink{T 03}: Hohe Fehlertoleranz\\
	\hyperlink{T 04}: Hohe Usability / Ansprechendes GUI-Design\\
	\hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie -1}{Strategie -1}: Name der minus ersten Strategie} \\
	Hier wird ein Text stehen, der die minus erste Strategie beschreibt. \\
	\textbf{\hypertarget{Strategie 0}{Strategie 0}: Name der nullten Strategie} \\
	Hier wird ein Text stehen, der die nullte Strategie beschreibt. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir denken, dass Strategie X die beste Option für uns ist. Dies liegt daran, dass ... hier steht die Begründung. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	01: Darstellung eines Graphen \\ \hline
	Es soll möglich sein einen Graphen gemäß des im Kapitel Definitionen, Akronyme und Abkürzungen beschriebenen \hyperlink{Syndromansatz}{Syndromansatzes} zu erstellen. Ein Graph besteht aus Sphären, den Sphären zugeordneten Symptomen und Relationen zwischen den Symptomen. Die Grapherstellung und -darstellung ist die wesentliche Funktion des Programmes.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 8 oder höher als Implementierungssprache\\
	\hyperlink{P01.3}{P01.3} Benutzung einer leichtgewichtigen Datenbank\\
	\hyperlink{P02.1}{P02.1} Betriebssystemunterstützung / Zielplattformen des Systems\\
	...
	\hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 1}{Strategie 1}: JUNG} \\
	JUNG (Java Universal Network/Graph Framework) ist eine Sprache zur Visualisierung, Modellierung und Analyse von Daten, die einen Graphen oder ein Netzwerk repräsentieren. JUNG ist in Java geschrieben und bietet unter anderem die Möglichkeit den Graphen mit Metadaten zu annotieren, was weitreichende Analysemöglichkeiten möglich macht. Darüber hinaus beinhaltet das Framework bereits Filter-Funktionalität und einige Layout-Algorithmen. Zu JUNG finden sich zudem viele Anwendungsbeispiele im Internet. \\
	\textbf{\hypertarget{Strategie 2}{Strategie 2}: JGraph} \\
	Bei JGraph handelt es sich um ein Framework welches die Grapherstellung unterstützt. Es hat den Fokus auf der Visualisierung des Graphen sofern man die im Framework bereits implementierten Methoden betrachtet. \\
	\textbf{\hypertarget{Strategie 3}{Strategie 3}: JGraphT} \\
	JGraphT ist eine Klassenbibliothek, die wie JGraph die Grapherstellung erleichtern soll. Der Fokus der von diesem Framework bereitgestellten Funktionen liegt jedoch eher auf der Analyse von Daten. Das Framework stellt unter anderem Algorithmen zum Finden von stark vernetzten Graphteilen und von \hyperlink{Kreislauf}{Kreisläufen} bereit.  \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir denken, dass Strategie 1 die beste Option für uns ist. Dies liegt vor allem an den umfangreichen Funktionen, die in dem Framework bereits implementiert sind und zum anderen daran, dass wir uns anhand der zahlreichen Codebeispiel im Internet gut in das Framework einarbeiten beziehungsweise mit recht hoher Wahrscheinlichkeit Lösungsansätze für möglicherweise auftretende Probleme finden werden. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	01: E-Mails verschicken können \\ \hline
	In der Anwendung muss eine Funktion zur Verfügung gestellt werden, mit der es möglich ist, (automatisiert) E-Mails zu verschicken.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	\hyperlink{P01.4}{P01.4} JSF verwenden \\
	\hyperlink{P02.1}{P02.1} Sicherheit / Datenschutz \\
	\hyperlink{P02.3}{P02.3} Mandantenfähiges System \\
	\hyperlink{P05.3}{P05.3} E-Mail-Generierung unterstützen \\
	\hyperlink{P05.4}{P05.4} Benachrichtigungen/Erinnerungen \\
	\hyperlink{P06.1}{P06.1} Zielplattform/Betriebssystemunterstützung \\
	\hyperlink{P06.3}{P06.3} Client: gängige Browser \\
	\hyperlink{P06.4}{P06.4} App-Entwicklung \\
	\hyperlink{P08}{P08} Client-Server-Architektur erforderlich \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 1}{Strategie 1}: Nutzung der von Glassfish zur Verfügung gestellten E-Mail-Funktion} \\
	Ein Verfahren, das wir nutzen könnten, um Nutzern unseres Systems die Möglichkeit zu geben E-Mails zu verschicken, ist die Verwendung von der E-Mail-Funktion von Glassfish. \\
	\textbf{\hypertarget{Strategie 2}{Strategie 2}: Selbstprogrammieren} \\
	Wir programmieren den E-Mail-Client selbst. \\
	\textbf{\hypertarget{Strategie 3}{Strategie 3}: Verlinkung des Nutzers zu seinem E-Mail-Client} \\
	Wir können dem Nutzer durch die Verlinkung mit seinem E-Mail-Client die Möglichkeit geben, in dem System E-Mails zu verschicken, was dann über seinen E-Mail-Account läuft. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir denken, dass Strategie 3 die beste Option für uns ist.\\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	02: Hohe Usability \\ \hline
	Die Anwendung soll alle Kriterien einer hohen Usability möglichst gut erfüllen.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.4}{P01.4} JSF verwenden \\
	\hyperlink{P05.2}{P05.2} Prüfungstermine verwalten / vorschlagen lassen \\
	\hyperlink{P05.3}{P05.3} E-Mail-Generierung unterstützen \\
	\hyperlink{P05.4}{P05.4} Benachrichtigungen/Erinnerungen\\
	\hyperlink{P07.2}{P07.2} Wiederverwendbarkeit bestehender LV unterstützen \\
	\hyperlink{P07.3}{P07.3} Prüfungs- / Notenhistorie \\
	\hyperlink{O 01}{O 01} Begrenzte Zeit / Abgabedatum \\
	\hyperlink{O 02}{O 02} Teamgröße \\
	\hyperlink{O 03}{O 03} Fähigkeiten \\
	\hyperlink{O 04}{O 04} Ansprechendes GUI-Design \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 4}{Strategie 4}: JSF-Framework-Verwendung} \\
	Mit der Verwendung von Boots- oder Primefaces, gelingt es uns eine hohe Usability zu erreichen, da sie uns viele Bibliotheken zur Verfügung stellen, welche sehr benutzerfreundlich sind. \\
	\textbf{\hypertarget{Strategie 5}{Strategie 5}: Hohe Fehlertoleranz} \\ 
	Mit einer hohen Fehlertoleranz können wir es schaffen das System aufrecht zu erhalten, auch bei einer fehlerhaften Eingabe. Dies führt zu einer hohen Usability. \\ \hline
	\textbf{Entscheidung} \\
	Wir denken, dass eine Kombination aus beiden Strategien die höchste Benutzerfreundlichkeit verspricht. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	03: Notenberechnung \\ \hline
	Wir müssen den Nutzern die Möglichkeit geben, mit den erreichten Teilleistungen Endnoten berechnen zu können.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	\hyperlink{P01.4}{P01.4} JSF verwenden \\
	\hyperlink{P02.1}{P02.1} Sicherheit / Datenschutz \\
	\hyperlink{P02.2}{P02.2} Datenbank-Backup \\
	\hyperlink{P04.1}{P04.1} CSV verarbeiten \\
	\hyperlink{P04.2}{P04.2} Kompatibilität zu PABO \\
	\hyperlink{P06.2}{P06.2} Bearbeitung des Datenbestandes im Browser auf normalen Desktop-Rechner ermöglichen \\
	\hyperlink{O 01}{O 01} Begrenzte Zeit / Abgabedatum \\
	\hyperlink{O 02}{O 02} Teamgröße \\
	\hyperlink{O 03}{O 03} Fähigkeiten \\
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 6}{Strategie 6}: Import/Export} \\
	Wir können es möglich machen, sich die Teilleistungen im CSV Format zu exportieren, damit man die Endnote außerhalb des Programms berechnen kann und die Endnote dann wieder importieren kann. \\
	\textbf{\hypertarget{Strategie 7}{Strategie 7}: Selbst programmieren} \\
	Wir könnten selbst einige Algorithmen zur Berechnung der Noten entwickeln, so dass sie direkt im System von dem Benutzer ausgerechnet werden lassen können. \\
	\textbf{\hypertarget{Strategie 8}{Strategie 8}: SQL} \\
	SQL ist eine Datenbanksprache zur Veränderung und Bearbeitung von Datenbeständen, mit deren Hilfe man die Notenberechnung ermöglichen könnte, da man die Datenbestände mit Hilfe von selbstgeschriebenen Formeln bearbeiten kann. \\
	\textbf{\hypertarget{Strategie 9}{Strategie 9}: Luaj} \\
	Luaj ist ein Java-Binding für die Skriptsprache Lua, die man in Programme einbinden kann, um beispielsweise die Notenberechnung durch eingegebene Formeln des Prüfers zu ermöglichen. Zudem ist die Größe des Skript-Interpreters sehr gering. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für den Import/Export da dies am einfachsten zu realisieren ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	\hypertarget{04: CSV Verarbeitung}{04: CSV Verarbeitung} \\ \hline
	Um die Notenberechnung mit der Strategie Export / Import zu lösen, benötigen wir Strategien für die Verarbeitung von CSV Formaten. \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{P04.1}{P04.1} CSV verarbeiten \\
	\hyperlink{P04.2}{P04.2} Kompatibilität zu PABO \\
	\hyperlink{P07.1}{P07.1} Hohe Usability \\
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 10}{Strategie 10}: Wir programmieren es selbst} \\
	Wir programmieren selbst einen Parser, der in der Lage ist CSV Dateien zu im- und exportieren.\\
	\textbf{\hypertarget{Strategie 11}{Strategie 11}: Open CSV } \\
	Open CSV ist eine Parser Library, welche uns die Möglichkeit gibt CSV Dateien ein- und auszulesen. Des Weiteren läuft es schon auf Java 7 und höher.\\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für die Nutzung von Open CSV, da es die einfachste Lösung für uns ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	05: Rollenkonzept \\ \hline
	Das System muss verschiedenen Nutzergruppen verschiedene Funktionen zur Verfügung stellen. Die unterschiedlichen Nutzer haben unterschiedliche Zugriffsrechte.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 12}{Strategie 12}: Enums} \\
	Wir können das Java eigene Konzept der Enumerationen verwenden. Bei dieser Datenstruktur kann man relativ einfach neue Nutzerklassen definieren, was vorteilhaft ist, wenn die Anwendung zukünftig in weiteren Fachbereichen benutzt werden soll. \\
	\textbf{\hypertarget{Strategie 13}{Strategie 13}: Shiro und JEE - Security} \\
	Shiro und JEE - Security sind Java Security Frameworks, welche auf Rollen und den dazugehörigen Rechten basieren. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für Strategie 13, weil es für uns die einfachste Alternative ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	06: Datenschutz \\ \hline
	Wir müssen alle datenschutzrechtlichen Bestimmungen beachten.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	\hyperlink{P02.2}{P02.2} Datenbank-Backup \\
	\hyperlink{P04.2}{P04.2} Kompatibilität zu PABO \\
	\hyperlink{P06.2}{P06.2} Bearbeitung des Datenbestandes im Browser auf normalen Desktop-Rechner ermöglichen \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 14}{Strategie 14}: Shiro} \\
	Shiro funktioniert mit jedem Datenmodell und bietet viele Sicherheitsoptionen, wie z.B. Authentifizierung, Autorisierung und Session-Management, zur Verstärkung des Datenschutzes.\\
	\textbf{\hypertarget{Strategie 15}{Strategie 15}: JEE - Security} \\
	JEE Security realisiert verschiedene Aspekte der Sicherheit die uns alle beim Realisieren des Datenschutzes helfen.\\\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für Strategie 14, da Shiro zugänglicher ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	07: Mandantenfähiges System \\ \hline
	Das System muss mehrere Benutzer gleichzeitig bedienen, ohne dass diese gegenseitigen Einblick in ihre Daten, Benutzerverwaltung und Ähnliches haben.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{P08}{P08} Client-Server-Architektur erforderlich \\ \hline
	\textbf{Lösung} \\
	\textbf{Strategie 14: Shiro} \\
	Shiro implementiert von sich aus einige Session Management Features, mit denen es möglich ist verschiedene Instanzen zu generieren und diese zu verwalten. \\
	\textbf{Strategie 15: JEE Security} \\
	Da JEE Security von sich aus schon ein Rollenkonzept initialisiert ist es automatisch möglich verschiedene Instanzen zu generieren.
	\\
	\\ \hline
	\textbf{Entscheidung} \\
	Hier entscheiden wir uns für Shiro, da wir es schon oft benutzen (konsistent) und es gut für unser Vorhaben geeignet ist.  \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	08: Lauffähig auf allen gängigen Browsern \\ \hline
	Das System soll auf allen gängigen Browsern (Safari, Firefox etc.) funktionieren.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	\hyperlink{P07.1}{P07.1} hohe Usability \\
	\hyperlink{P08}{P08} Client-Server-Architektur erforderlich \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 16}{Strategie 16}: Plattformunabhängige Komponenten} \\
	Bei Implementierung unseres Systems verwenden wir ausschließlich Komponenten, Frameworks und Features, von denen wir im Voraus sichergestellt haben, dass sie auf allen Browsern lauffähig sind. \\
	\textbf{\hypertarget{Strategie 17}{Strategie 17}: Nutzung von JavaScript} \\
	Durch die Nutzung von JavaScript und JSF ist es sichergestellt, dass unser System auf allen gängigen Browsern läuft, da diese kompatibel zu allen Browsern sind. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Da wir die Anforderung haben, das System in Java zu implementieren, entscheiden wir uns für  Strategie 17. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	09: Ansprechendes GUI-Design \\ \hline
	Das Erscheinungsbild des Systems soll für den Benutzer ästhetisch sein. \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	\hyperlink{P01.4}{P01.4} JSF verwenden \\
	\hyperlink{P06.1}{P06.1} Zielplattform/Betriebssystemunterstützung \\
	\hyperlink{P06.4}{P06.4} App-Entwicklung \\
	\hyperlink{P07.1}{P07.1} Hohe Usability \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 18}{Strategie 18}: Wir benutzen JSF Frameworks (Boots- und PrimeFaces)} \\
	Mit Primefaces oder Bootsfaces können wir die GUI schön gestalten, da schon fertige und ansprechende Widgets existieren.\\
	\textbf{\hypertarget{Strategie 19}{Strategie 19}: Nutzung von Ice- und RichFaces} \\
	Mit diesen Frameworks könnten wir ebenfalls die GUI gestalten. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für die Nutzung von Boots- und PrimeFaces, da diese noch weiterhin supportet werden und zudem ansprechender wirken, was ein relevanter Aspekt für ein ansprechendes GUI Design ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	10: Kalender \\ \hline
	Es soll ein Kalender existieren, in welchem man Termine verwalten und einsehen kann.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.4}{P01.4} JSF verwenden \\
	\hyperlink{P02.1}{P02.1} Sicherheit / Datenschutz \\
	\hyperlink{P02.2}{P02.2} Datenbank-Backup \\
	\hyperlink{P02.3}{P02.3} Mandantenfähiges System \\
	\hyperlink{P03.2}{P03.2}  ICS - Dateigenerierung \\
	\hyperlink{P05.2}{P05.2} Prüfungstermine verwalten / vorschlagen lassen \\
	\hyperlink{P05.4}{P05.4} Benachrichtigungen/Erinnerungen \\
	\hyperlink{P07.1}{P07.1} hohe Usability \\
	\hyperlink{P08}{P08} Client-Server-Architektur erforderlich \\
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 20}{Strategie 20}: Primefaces Schedule} \\
	Wir benutzen den Kalender von Primefaces, welcher schon viele Funktionen und ein gutes Design mit sich bringt. \\
	\textbf{\hypertarget{Strategie 21}{Strategie 21}: Bootsfaces Kalender} \\
	Wir benutzen den Kalender von Bootsfaces, welcher schon viele Funktionen und ein gutes Design mit sich bringt. \\
	\textbf{\hypertarget{Strategie 22}{Strategie 22}: Wir entwickeln selbst einen Kalender} \\
	Wir können den Kalender selbst programmieren, um ihn direkt auf unsere Anforderungen anpassen zu können. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für den Kalender von Primefaces, da dieser ästhetischer ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	11: Passwort ändern \\ \hline
	Es soll möglich sein, das eigene Passwort zu ändern und zurückzusetzen. \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.4}{P01.4} JSF verwenden \\
	\hyperlink{P02.1}{P02.1} Sicherheit / Datenschutz \\
	...
	\hyperlink{P07.1}{P07.1} hohe Usability \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 23}{Strategie 23}: Nutzung von Security-Frameworks in Kombination mit der E-Mail Anwendung} \\
	Mit unserer E-Mail Anwendung schicken wir dem Benutzer eine E-Mail mit weiteren Schritten, um sein Passwort zurückzusetzen. In Kombination mit dem Security-Framework sollte sich dies realisieren lassen. \\
	\textbf{\hypertarget{Strategie 24}{Strategie 24}: Nachricht an den Admin} \\
	Der Nutzer schreibt dem Admin eine Nachricht, in welcher er ihn darüber informiert, dass er sein Passwort ändern oder zurücksetzen möchte.
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für Strategie 23, da diese am sichersten und verlässlichsten erscheint.\\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	12: PDF-Generierung \\ \hline
	Es soll für den Prüfer möglich sein, eine Quittung zu erstellen. Dabei wird ein PDF mit allen Informationen zu dem jeweiligen Prüfling, der Prüfung und dem Ergebnis (optional), generiert.\\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 25}{Strategie 25}:  Java PDF Library Apache PDFBox} \\
	Java PDF Library Apache PDFBox ist eine Library, die es uns nicht nur die Erstellung, sondern auch die Manipulation von PDFs ermöglicht.\\
	\textbf{\hypertarget{Strategie 26}{Strategie 26}: PDF Library iText} \\
	Diese Library ist weit verbreitet für die Erstellung und Bearbeitung von PDF Dokumenten, welche in Java geschrieben ist.\\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für Strategie 25, weil es noch unterstützt wird und leicht zu implementieren ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	13: Wartbarkeit \\ \hline
	Das System muss nach der Auslieferung leicht wartbar sein, das bedeutet wir müssen es verständlich und leicht änderbar entwerfen.\\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.4}{P01.4} JSF verwenden \\
	...
	\hyperlink{P07.1}{P07.1} hohe Usability \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 27}{Strategie 27}:  Dokumentation des Quellcodes} \\
	Wir streben es an, den wichtigen Quellcode zu dokumentieren, damit spätere Entwickler sich leicht reinlesen und es warten können. \\
	\textbf{\hypertarget{Strategie 28}{Strategie 28}: Modularisierung} \\
	Eine weitere Strategie ist die Modularisierung, wodurch wir eine geringe Kopplung und hohe Kohäsion erreichen können. Durch die Zerlegung des Systems in einzelne Module, ist es für einen Entwickler, der das Sytsem warten muss einfacher einzelne Module auszutauschen oder zu bearbeiten.\\
	\textbf{\hypertarget{Strategie 29}{Strategie 29}: Redundanzvermeidung} \\
	Wenn wir Redundanzen vermeiden, ist es für den späteren Programmierer, der das System warten soll, einfacher Probleme zu beheben. Des Weiteren ist es übersichtlicher für jeden der sich den Code anguckt. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für eine Kombination aller Strategien, da sie alle leicht zu berücksichtigen sind und für eine hohe Wartbarkeit zusammenspielen müssen. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	14: PABO-Import\\ \hline
	Ein Prüfer/Sekretär soll die Möglichkeit haben die teilnehmenden Prüflinge aus PABO zu importieren.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{P02.3}{P02.3} Mandantenfähiges System \\
	\hyperlink{P04.1}{P04.1} CSV verarbeiten \\
	\hyperlink{P05.1}{P05.1} Rollenkonzept \\
	\hyperlink{P07.1}{P07.1} hohe Usability \\
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{Strategie 11: OpenCSV } \\
	OpenCSV ist eine Parser Library, welche uns die Möglichkeit gibt CSV Dateien ein- und auszulesen. Des Weiteren läuft es schon auf Java 7 und höher.\\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir benutzen OpenCSV, da es sich anbietet aufgrund unserer gewählten Strategie zur Problemkarte \hyperlink{04: CSV Verarbeitung}{04: CSV Verarbeitung} \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular}  {|p{14cm}|}
	\hline
	15: Synchronisation mit Google-Kalender\\ \hline
	Der Kalender unseres Systems soll mit dem Google-Kalender des Benutzers optional synchronisiert werden. \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 30}{Strategie 30}: Google Kalender Java API} \\
	Wir benutzen die Java API von Google, welche direkt bereitgestellt wird, da diese eine so hohe Qualität bietet, ist es die beste Option.  \\ \hline
	\textbf{Entscheidung} \\
	Wir denken, dass Strategie 30 die einzige und beste Option für uns ist. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	16: Terminvorschläge \\ \hline
	Ein Prüfer hat die Möglichkeit, durch Angabe eines Zeitfensters, Prüfungsdauer und Pausendauer, Termine für seine Prüfungen vorgeschlagen zu bekommen.  \\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 31}{Strategie 31}: Selbst programmieren} \\
	Wir programmieren einen Algorithmus, der Termine für einen angegebenen Zeitraum und weiteren möglichen Angaben vorschlägt. \\
	\\ \hline
	\textbf{Entscheidung} \\
	Wir entscheiden uns für die oben beschriebene Strategie, da es keine andere Möglichkeit gibt dies zu realisieren.\\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular}  {|p{14cm}|}
	\hline
	17: Krankmeldungen \\ \hline
	Falls ein Prüfling verhindert ist, gibt es eine Funktion mit der er dem Prüfer der jeweiligen Prüfung eine vorgefertigte Email schicken kann. Der Prüfer bekommt dies sofort angezeigt und kann es im System hinterlegen.   \\
	\textbf{Einflussfaktoren} \\
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	\hyperlink{P02.1}{P02.1} Sicherheit / Datenschutz \\
	\hyperlink{P03.1}{P03.1} Dokument- / Dateiupload \\
	\hyperlink{P07.1}{P07.1} hohe Usability \\
	\hyperlink{T 01}{T 01} Fehlertoleranz \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 32}{Strategie 32}: Wir programmieren es selbst} \\
	Wir programmieren die Option selber, dass der Prüfling den Prüfer über seine Krankmeldung informieren kann. Dies kann man mit unserer Email-Funktion realisieren. \\ \hline
	\textbf{Entscheidung} \\
	Hier entscheiden wir uns für die einzige aufgeführte Strategie, da wir für dieses Problem keine andere Strategie finden. \\ \hline
\end{tabular}
\\ \\ \\
\begin{tabular} {|p{14cm}|}
	\hline
	18: Unregistrierte Person erstellen \\ \hline
	Wir müssen auch unregistrierte Personen hinzufügen können, welche dann aufgefordert werden sollten, sich zu registrieren.\\
	\textbf{Einflussfaktoren} \\ 
	\hyperlink{P01.1}{P01.1} Java 7 oder höher als Implementierungssprache \\
	\hyperlink{P01.2}{P01.2} Obligatorische Nutzung von GlassFish inklusive Derby \\
	\hyperlink{P01.3}{P01.3} Maven als Build-System \\
	...
	\hyperlink{P08}{P08} Client-Server-Architektur erforderlich \\ \hline
	\textbf{Lösung} \\
	\textbf{\hypertarget{Strategie 33}{Strategie 33}: Link in E-Mail} \\
	Falls ein Benutzer jemanden hinzufügen möchte, der noch nicht im System registriert ist, kann er dieser Person eine vorgefertigte Email schicken, in der ein Link ist, welcher den Empfänger zur Registrierung führt. \\
	\hline
	\textbf{Entscheidung} \\
	Wir denken, dass die aufgeführte Strategie die beste Lösung für dieses Problem darstellt. \\ \hline
\end{tabular}
\\ \\ \\
...
Die Grundstruktur unserer Architektur ist angelehnt an das Model-View-Controller Designpattern kombiniert mit dem Command Designpattern wie erwähnt in der Problemkarte “Auswahl der grundlegenden Softwarearchitektur”. 
...
Die Persistence-Komponente wurde gemäß “Kommunikation Zielplattform (Java) mit embedded DB” mit Hibernate realisiert.
Hibernate gibt die verarbeiteten Informationen über einer data-Schnittstelle weiter an die Database, die anschließend die Informationen speichert. Die Database-Komponente wird realisiert mit einer H2 Database wie in der Problemkarte “Verwendung einer Embedded Database” beschrieben. \\ \\
Gemäß der Strategie in ”Protokolldaten und Graphdaten zusammen sichern” wird dies umgesetzt in der Komponente NewDatatype.
Für das Problem “PDF Erstellung” bilden wir alle Grafikkontexte auf der java.awt.Graphics2D ab und nutzen die Komponente FreeHEB Vectorgraphics um java.awt.Graphics2D als zahlreiche Formate (z.B. SVG, PDF) zu exportieren, wie erwähnt in “Bibliothek für den PDF Export von java.awt.Graphics2D”. Dafür benötigen wir von der JUNG-Komponente nur die Visualization-Komponente, die über einer data-Schnittstelle übermittelt wird. \\ \\
Um den Graphen auswerten zu können, benutzen wir die Graph-Komponente in JUNG. Da die Komponente jedoch nicht den benötigten Funktionsumfang deckt, haben wir in unsere Applikation auch die JGraphT-Komponente eingebaut gemäß der beschriebenen Strategie in “Auswertung von Grapheigenschaften”. Dafür wird die Logik des Graphen übersetzt, so dass JGraphT die Informationen nutzen kann und anschließend über eine data-Schnittstelle an die JGraphT-Komponente übertragen. \\ \\
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{KonzeptionelleSicht.JPG}
...
\emph{Autoren: Anthony Mendil, Clement Phung}\\ \\
...
Im folgenden wird die Modulsicht abgebildet, welche den Aufbau unseres Programms darstellt. Da wir uns auf das Entwurfsmuster Model-View-Controller festgelegt haben, ist der folgende Abschnitt in die drei Sektoren aufgeteilt.
\begin{figure}[ht]
	\centering
	\caption{Modulsicht}
\end{figure}
...
\noindent\hspace*{0mm}%
Allgemein haben wir darauf geachtet die Architektur so aufzubauen, dass sie leicht erweiter- und wartbar ist, weswegen wir stark modularisiert haben und auf Redundanzvermeidung geachtet haben (siehe \hyperlink{Strategie 28}{Strategie 28} \& \hyperlink{Strategie 29}{Strategie 29}).
In diesem Abschnitt beschreiben wir die Maßnahmen, die wir getroffen haben, damit unsere Anwendung an sich ändernde Anforderungen angepasst werden kann. Dazu betrachten wir die entsprechenden Komponenten der Architektur und erklären, inwiefern sie jeweils zur Anpassbarkeit beiträgt.\\ \newline
Um eine möglichst hohe Persistenz unserer Daten gewährleisten zu können, haben wir verschiedene Persistenzklassen angelegt, die alle ein (Persistenz-)Interface implementieren. Dadurch haben die verschiedenen Klassen die Basisfunktionen, die ihnen durch dieses Interface (OperationPersistence) vorgeschrieben werden. Einige Klassen haben dann individuell noch zusätzliche Methoden, mit denen sie auf den Datenbestand der Datenbank zugreifen können. Dieser strukturelle Aufbau zur Sicherstellung kontrollierter Datenbankzugriffe, der einer langfristig zweckdienlichen Speicherung der Daten dient, ist insofern förderlich für die Evolution der Anwendung, als dass es leicht möglich ist, weitere Persistenzklassen (mit denen für sie nötigen Methoden) hinzuzufügen. Dies ist dann erforderlich, wenn weitere Komponenten durch hinzukommende Anforderungen in der Architektur benötigt werden. Vorstellbar wäre zum Beispiel, dass es in einer ILV einen Chat zwischen allen Teilnehmern und Prüfern in Form eines Forums geben soll. Der dafür nötigen Komponente müsste eine Persistenzklasse zugeordnet werden - vorausgesetzt, die Nachrichten des Chats sollen nicht nach sehr kurzer Zeit aus dem Speicher verschwinden und dürfen nicht komplett unstrukturiert hinterlegt werden. \\
Des Weiteren dient die Hinzunahme der Persistenz-Klassen als Ganzes dazu, später bei Bedarf leichter die Datenbank selbst wechseln zu können. \\ \newline
Das Rollenkonzept ist auch leicht erweiter- und änderbar. Wir haben es mittels einer eigenen Klasse (RoleModel) umgesetzt. Diese Klasse enthält alle Rollen, die aktuell in unserer Anwendung benötigt werden als Attribute vom Typ der Klasse. Man kann bei Bedarf einfach Rollen ergänzen, verändern und auch entfernen. In jedem Fall bleibt es möglich, dass ein Nutzer unseres Systems mehrere Rollen haben kann. Dies haben wir durch eine Liste von Rollen sichergestellt, die Teil jedes Profils ist. \\ \newline
Wir haben uns überlegt, alle Aspekte, die einen Nutzer unserer Anwendung betreffen mit den drei Model-Klassen ProfilModel, UserModel und RoleModel umzusetzen. Letztere ist wie eben beschrieben lediglich dafür da, dass weitere Rollen in das Rollenkonzept möglichst unkompliziert hinzugefügt werden oder bestehende Rollen angepasst und entfernt werden können. Während dem UserModel lediglich eine E-Mail und ein Passwort (in Form von Attributen) zugeordnet sind, realisiert das ProfileModel alle verbleibenden Aspekte, die einen Nutzer betreffen.\\ \newline
Durch die zentrale Position des ILVControllers in der Architektur in Zusammenhang damit, dass viele Aspekte als Klassen realisiert sind, die dann mit dem ILVController assoziiert sind, ergibt sich eine hohe Erweiterbarkeit von Aspekten/Funktionen, die im Zusammenhang mit der ILV stehen. Es können so recht leicht weitere Klassen (Controller-Klassen) ergänzt werden, die dann die benötigten Aspekte realisieren. Hierfür ist dann je nach sich ändernden hinzukommendem Aspekt nur in recht wenig Controller einzugreifen. \\ \newline
Durch die Verknüpfung von RegistrationUserController mit ProfileController und mit UserController ist ein relativ kleiner (Controller-)Klassen-Umfang gegeben, der die Aspekte der Registration von Nutzern realisiert. \\
Durch die Verbindung der LoggingController-Klasse mit der UserController-Klasse, die ihrerseits wieder mit der ProfileController-Klasse in Verbindung steht sind ebenfalls in einem kleinen Klassenumfang die Aspekte des Logins und Lougouts realisiert. \\
Dadurch können Änderungen im Bezug auf das Registrieren sowie das Login und Logout bei Bedarf geändert werden, ohne dass eine Vielzahl von Klassen geändert werden müssen.
