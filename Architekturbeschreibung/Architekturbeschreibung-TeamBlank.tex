...
In der folgenden Abbildung ist unsere Ausführungssicht zu erkennen. Da der Aufbau unserer Software dem einer lokalen Anwendung entspricht, wird es pro Nutzer genau eine Instanz der Anwendung geben und ist die zeitgleiche Ausführung mehrerer Instanzen unserer Anwendung nicht vorgesehen. \\
...
Im selben Prozess werden Import und Export durch das Modul \texttt{io} geregelt. Diese Funktionen werden ebenfalls durch Action-Objekte aus \texttt{actions} ausgelöst. \\
...
Eine Alternative zu der bestehenden Version wäre die Realisierung der Anwendung durch mehrere Threads. Eine Möglichkeit wäre es, die GUI in einem eigenen Thread laufen zu lassen (siehe folgende Abbildung: Ausführungssicht der Multithread-Version). Dies könnte helfen, eine durchgehend ansprechbare und dadurch angenehmer bedienbare Benutzeroberfläche, gemäß \hyperlink{g}{Hoher Usability}, zu entwickeln. Falls unsere Architektur diese Aspekte nicht ausreichend abdeckt, was in Tests späterer Entwicklungsphasen auffallen würde, dann ist es immer noch möglich, auf dieses Modell umzusteigen. \\
