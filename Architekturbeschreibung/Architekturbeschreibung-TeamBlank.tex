...
\subsection{Anwendungsfall: Ein Lehrer erstellt einen Syndromansatz und fügt eine Sphäre hinzu}

\begin{tabular} {|p{16cm}|}
	\hline
	\rowcolor{anw}\parbox{16cm}{\textbf{A1: Ersteller erstellt Syndromansatz und fügt eine Sphäre hinzu}} \\\hline
	\hline
	\textbf{Akteure}: Ersteller
	\\\hline
	\textbf{Vorbedingungen}: Das Programm ist geöffnet, es wurden noch kein Graph erstellt und keine Einstellungen gesetzt. \\
	\textit{Ziel}: Einen Syndromansatz erstellen und eine Sphäre hinzufügen.
	\\\hline
	...
	\end{itemize}
	\\\hline
	\textbf{Varianten}: Der Ersteller könnte weitere Element zu dem Graphen hinzufügen und diese miteinander verknüpfen.
	\\\hline
...
\begin{tabular} {|p{16cm}|}
	\hline
	\rowcolor{anw}\parbox{16cm}{\textbf{A3: Auswerter wertet Graph aus}} \\\hline
	\hline
	\textbf{Akteure}:  Auswerter
	\\\hline
	\textbf{Vorbedingungen}: Das Programm ist geöffnet, ein bearbeiteter Syndromansatz in Form einer OOF-Datei ist schon importiert. \\ 
	\textit{Ziel}: Syndromansatz auswerten.
	\\\hline
	\textbf{Regulärer Ablauf}:
\begin{itemize}
	\itemsep-1.3em
	\item der Auswerter klickt auf den Menüpunkt \textit{Auswertermodus}
...
\end{itemize}
	\\\hline
	\textbf{Varianten}: Der Auswerter könnte nach vielen Kriterien filtern und diese auch in Kombination verschiedener Kriterien filtern. Ebenfalls kann man manche Elemente ausblenden um unnötige Aspekte zu ignorieren.
	\\\hline
...
\begin{itemize}
	\itemsep-0.7em
	\item der Bearbeiter klickt auf den Menüpunkt \textit{Datei} $\rightarrow$ \textit{exportieren als} $\rightarrow$ \textit{OOF}
	\item das System öffnet ein Pop-Up-Eingabefeld
...
\end{itemize}
	...
	\\\hline
	\textbf{Nachbedingung}: Der Graph ist nun als PDF und als OOF-Format exportiert. Die OOF-Datei kann der Bearbeiter nun weitergeben, sodass jemand anderes den Bearbeiter auswerten kann. 
	\\\hline
	\textbf{Fehler-/Ausnahmefälle mit deren Nachbedingung}: Der Bearbeiter könnte nun im Bearbeitermodus den Graphen modifizieren oder als eine Vorlage für spätere Verwendung exportieren.
	\\\hline
\end{tabular}\\ \\ \\
