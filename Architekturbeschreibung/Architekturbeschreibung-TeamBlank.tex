...
\begin{tabular} {|p{16cm}|}
	...
	\\\hline
	\textbf{Fehler-/Ausnahmefälle}:  Der Bearbeiter könnte die Sphäre an eine ungünstige Stelle setzen $\rightarrow$ Der Ersteller kann mithilfe des \textit{Sphäre löschen}-Buttons die Sphäre löschen und mit dem \textit{Sphäre hinzufügen}-Button neu setzen. 
	\\\hline
\end{tabular}
\\ \\ \\
