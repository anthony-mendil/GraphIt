...
Zum Auswerten der Graph-Eigenschaften wird in einigen Fällen das Modul \texttt{jgrapht} (\hyperlink{xxx}{Strategie S25 - JgraphT}) benötigt und in anderen Funktionen des Frameworks JUNG(\hyperlink{fff}{S22 - JUNG}). Auch diese Funktionen werden von den Actions ausgelöst.\\
