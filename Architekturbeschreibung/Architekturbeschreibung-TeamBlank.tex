...
Über die injizierten Instanzen der \texttt{Syndrom}- und \texttt{GraphDao}-Klasse, erhalten die Objekte der \texttt{GXLio} Klasse alle Informationen zu dem in der GUI visualisierten Graphen. Das Injizieren ist mittels Dependency Injection und über gemäß Strategie \hyperlink{abcd}{S66 - Google Guice} über das Framework Guice umgesetzt. \\
