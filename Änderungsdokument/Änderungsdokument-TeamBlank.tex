...
Im Gegenzug zu dem Datenmodell in der Architekturbeschreibung, wurde die Klasse Syndrom komplett entfernt. Zum einen haben wir festgestellt, dass die zahlreichen Attribute teilweise nicht notwendig waren, da diese über den \texttt{VisualisationViewer} gesetzt werden und somit in Syndrom nur eine doppelte Instanziierung. Zum anderen hat Syndrom zusätzliche Funktionalität erhalten und ist somit keine reine Datenklasse mehr und musste streng genommen aus dem Datenmodell entfernt werden.\\
...
\newline 
\begin{center}
	\includegraphics[height=18cm, angle=90]{Datenmodell_SWP2019.PNG}
\end{center}
